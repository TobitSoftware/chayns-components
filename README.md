...
| [AmountControl&nbsp;›](docs/components/amount-control.md)              | The AmountContrl is a three-segment control used to increase or decrease an incremental value.                                                                                                                                                                                                             |
...
| [Checkbox&nbsp;›](docs/components/checkbox.md)                         | Checkboxes allow users to complete tasks that involve making choices such as selecting options. Can be styled as a switch, avisual toggle between two mutually exclusive states — on and off.                                                                                                              |
