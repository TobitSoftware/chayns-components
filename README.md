...
The **@chayns-components** project provides a collection of reusable UI components, hooks, and
utilities  
for developing scalable and consistent **chayns web applications**.

All packages are managed in a single **Lerna + TypeScript** monorepo, allowing shared
configuration,  
