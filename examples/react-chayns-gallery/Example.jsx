...
export default class GalleryExample extends PureComponent {
    render() {
        const images = [
            ...
            'https://pixabay.com/get/57e8d7454951ab14f6d1867dda6d49214b6ac3e45654794a702a7bd494/christmas-1826337_1920.jpg',
            {
                url: 'https://pixabay.com/get/54e8d64a4b52ae14f6d1867dda6d49214b6ac3e45654794a702b72d693/creux-du-van-2839102_1920.jpg',
            },
            {
        ...
        return (
            <div>
                ...
                <Gallery style={{ marginBottom: '30px' }} deleteMode dragMode images={images} />
