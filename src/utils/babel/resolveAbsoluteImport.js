module.exports = function resolveAbsoluteImport(importName) {
    const values = {
        ...
        AnimationWrapper:
            'react-chayns-animation_wrapper/component/AnimationWrapper.js',
        ...
        TransparencySlider:
            'react-chayns-color_picker/component/transparencySlider/TransparencySlider.js',
        ColorInput:
            'react-chayns-color_picker/component/colorInput/ColorInput.js',
        ...
        ExpandableContent:
            'react-chayns-expandable_content/component/ExpandableContent.js',
        FilterButton: 'react-chayns-filterbutton/component/FilterButton.js',
        FormattedInput:
            'react-chayns-formatted_input/component/FormattedInput.js',
        ...
        ImageAccordion:
            'react-chayns-image_accordion/component/ImageAccordion.js',
        ImageAccordionGroup:
            'react-chayns-image_accordion/component/ImageAccordionGroup.js',
        Input: 'react-chayns-input/component/Input.js',
        IntegerFormatter:
            'react-chayns-formatted_input/utils/IntegerFormatter.js',
        ...
        DecimalFormatter:
            'react-chayns-formatted_input/utils/DecimalFormatter.js',
        ...
        SimpleWrapperContext:
            'react-chayns-personfinder/component/data/simpleWrapper/SimpleWrapperContext.js',
        ...
        ResultSelection:
            'react-chayns-searchbox/component/result-selection/ResultSelection.js',
        ...
        withSetupWizardContext:
            'react-chayns-setupwizard/component/withSetupWizardContext.js',
        SharingBar: 'react-chayns-sharingbar/component/SharingBar.js',
        SmallWaitCursor:
            'react-chayns-smallwaitcursor/component/SmallWaitCursor.js',
        ...
        FORMAT_INTEGER:
            'react-chayns-formatted_input/utils/instances/formatInteger.js',
        FORMAT_DECIMAL:
            'react-chayns-formatted_input/utils/instances/formatDecimal.js',
        FORMAT_PRICE:
            'react-chayns-formatted_input/utils/instances/formatPrice.js',
    };
