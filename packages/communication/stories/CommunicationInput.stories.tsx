...
const WithAudioInputTemplate: StoryFn<typeof CommunicationInput> = (args) => {
    const [value, setValue] = useState('');
...
export const WithAudioInput = WithAudioInputTemplate.bind({});
