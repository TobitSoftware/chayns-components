        ...
        <Accordion title={'SetupWizard inside an Accordion'}>
            <SetupWizard {...args} ref={setupRef}>
                <SetupWizardItem id={0} step={1} title="Intro" isWrapped>
                    ...
                    non orci facilisis mattis at a justo. Nam tempor lacinia nisl id sagittis. Nunc
                    ultricies ex eros, ac lobortis nulla lobortis vel. Integer volutpat sem sem, id
                    aliquam magna viverra nec. In tempus neque quis urna facilisis, vel pulvinar
                    sapien pretium. Vivamus condimentum dignissim massa eu posuere. Sed rutrum, enim
                    vel ullamcorper lobortis, libero turpis ultrices metus, in sodales lectus dui et
                    lorem. Donec tincidunt arcu diam, et maximus nibh convallis sit amet. Aenean
                    tristique et felis at dignissim. Nam a interdum risus, sit amet vestibulum
                    turpis. Integer dolor risus, sodales a faucibus eu, iaculis dignissim augue.
                    <div style={{ display: 'flex', justifyContent: 'center', marginTop: 10 }}>
                        <Button
                            onClick={() => {
                                setupRef.current.next();
