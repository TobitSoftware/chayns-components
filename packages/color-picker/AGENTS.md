...
- Start with one of the documented Storybook examples and adapt the props incrementally for your use
  case.
- Pay special attention to required props: `shouldHideColorArea`, `shouldHideDefaultPresetColors`,
  `shouldShowMoreOptions`, `shouldShowPresetColors`, `shouldShowTransparencySlider`,
  `shouldUseSiteColors`.
