...
const CustomChildrenTemplate: StoryFn<typeof ColorPicker> = ({ ...args }) => {
    const [color, setColor] = useState('rgba(255, 0, 0, 1)');
    ...
    return (
        <ColorPicker
            ...
            onSelect={(newColor) => setColor(newColor)}
        >
            <Icon color={color} icons={['fa fa-paint-roller']} size={32} />
        </ColorPicker>
    );
};

export const General = Template.bind({});
export const WithCustomChildren = CustomChildrenTemplate.bind({});
