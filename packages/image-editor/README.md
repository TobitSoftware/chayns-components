...
First you need to install the image-editor part of the chayns-components.

```bash
# NPM
npm install @chayns-components/image-editor

# Yarn
yarn add @chayns-components/image-editor
```
